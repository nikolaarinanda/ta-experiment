...
from datareader_cyb import CyberbullyingCommentDataset
from torch.utils.data import DataLoader
import torch.nn.functional as F
from model import TextCNNHeavy
import numpy as np
import random
...
def get_model(model_name, vocab_size, embed_dim, num_classes):
    if model_name.lower() == "textcnn":
        return TextCNNHeavy(vocab_size=vocab_size, embed_dim=embed_dim, num_classes=num_classes)
    else:
...
def main():
    ...
    train_dataset = CyberbullyingCommentDataset(
    ...
    val_dataset = CyberbullyingCommentDataset(
        file_path="dataset/dataset_cyberbullying.xlsx",
        tokenizer_name="indobenchmark/indobert-base-p1",
        folds_file="cyberbullying-datareader-simple-folds.json",
        random_state=2003,
